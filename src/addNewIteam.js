const addNewIteam = () => {      
    ...
    addDataToStorage(selectedFile,name,description,category);
}   
...
const addDataToStorage = (selectedFile,name,description,category) =>{
...
module.exports = {addNewIteam,loadOnce,addDataToStorage}
