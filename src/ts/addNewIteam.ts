...
const addNewIteam = () => {    
  let name:string = (<HTMLInputElement>document.getElementById('ItemName')).value;
  let description:string =(<HTMLInputElement>document.getElementById('ItemDescrimption')).value;
  let category:string =(<HTMLInputElement>document.getElementById('ItemCategory')).value ;
  let selectedFile:any = (<HTMLInputElement>document.getElementById('ItemCategory')).files;  
